...
<main>
    ...
    <figure class="hero">     
            <img class="picture" src="img/services.jpg" id="pic" alt="elder couple">
        <figcaption>
            <h1>Services</h1>
        </figcaption>
    </figure>
        ...
        <h2>Our Services</h2>
            <ul>
                ...
                <li>Care in the comfort of your home or elsewhere, our custom services are provided in many settings.</li>

                <figure>
                    <img class="picture" src="img/appointment.jpg" id="pic" alt="appointment" >
                </figure> 
                <li>We can run errands and go to appointments with you, as well as setting reminder for you.</li>

                <figure>
                    <img class="picture" src="img/companion.jpg" id="pic" alt="companion" >
                </figure> 
                <li>We provide one-on-one companionship care and homemaking.</li>
    ...
    <figure class="hero">     
        ...
        <h2>Lời Hứa</h2>
        <p>Tại Motherly Home Care, sự an toàn và hài lòng là trên hết. Chúng tôi dành thêm thời gian để đảm bảo các nhu cầu của bạn được đáp ứng, đồng thời còn vượt lên trên để bạn có thể tận hưởng cuộc sống theo cách bạn muốn. Bạn sẽ luôn được đối xử như một gia đình tại Motherly Home Care.</p>
        <h2>Chăm Sóc Yêu Thương</h2>
            <ul>
                ...
                <li>Theo dõi mạch, huyết áp, thân nhiệt, giấc ngủ.</li>

                <figure>
                <img class="picture" src="img/meal_prep.jpg" id="pic" alt="mealprep" >
                </figure> 
                <li>Chăm sóc bữa ăn và dọn dẹp.</li>

                <figure>
                    <img class="picture" src="img/appointment.jpg" id="pic" alt="appointment" >
                </figure> 
                <li>Trò chuyện, đưa bạn đi bác sĩ, đi dạo, hỗ trợ về mặt tinh thần và xoa bóp những nơi khó chịu</li>
    </div>
</main>
